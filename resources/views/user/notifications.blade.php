...
@section('content')
    ...
    @include('partials.shell.page-header', [
        'title' => 'Notifications',
        'subtitle' => 'Stay updated on campus activity',
    ])
    ...
    <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
        ...
        <div class="flex flex-wrap gap-3">
            <form method="POST" action="{{ route('user.notifications.action', 'mark_all_read') }}" data-notification-action>
                @csrf
            ...
            <form method="POST" action="{{ route('user.notifications.action', 'clear_all') }}" onsubmit="return confirm('Clear all notifications?')">
                @csrf
    ...
    @include('partials.notifications.filters', [
        'clearRoute' => route('user.notifications'),
        'types' => ['all', 'Violation', 'Parking', 'General', 'System'],
    ])
    ...
    <div class="overflow-hidden rounded-xl border border-gray-200 bg-white">
                ...
                <div class="flex flex-wrap items-start justify-between gap-3">
                    ...
                    <div class="flex flex-col items-end gap-2">
                        ...
                        @unless ($notif->is_read)
                            <form method="POST" action="{{ route('user.notifications.action', 'mark_read') }}" data-notification-action>
                                @csrf
        ...
        @empty
            <p class="px-6 py-12 text-center text-gray-500">No notifications yet.</p>
        @endforelse
    </div>
