...
@section('content')
    <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
        <div class="mb-6 text-center sm:mb-8">
            ...
            <p class="mt-2 text-sm text-gray-500">Join the CSPC Vehicle Management System</p>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <x-auth.input label="Full Name" name="fullname" required placeholder="Juan Dela Cruz" value="{{ old('fullname') }}" />
                    <div>
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <select
                            ...
                            id="user_type"
                            required
                            class="w-full rounded-lg border border-gray-300 bg-white px-3 py-2.5 text-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 @error('user_type') border-red-500 @enderror"
                        >
                    ...
                    <div>
                        ...
                        <select
                            ...
                            id="department_code"
                            required
                            class="w-full rounded-lg border border-gray-300 bg-white px-3 py-2.5 text-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 @error('department_code') border-red-500 @enderror"
                        >
            ...
            <button
                type="submit"
                class="flex w-full items-center justify-center gap-2 rounded-lg bg-blue-600 py-3 text-sm font-semibold text-white transition-colors hover:bg-blue-700"
            >
        ...
        <p class="mt-6 text-center text-sm text-gray-500">
            ...
            <a href="{{ route('login') }}" class="font-semibold text-blue-600 hover:text-blue-700 hover:underline">Sign in here</a>
        </p>
        </div>
@endsection 
