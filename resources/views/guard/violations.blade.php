        ...
        <div class="max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-2xl bg-white p-6 shadow-xl">
            ...
            <form method="POST" action="{{ route('guard.violations.store') }}" enctype="multipart/form-data" class="space-y-4">
                ...
                <div>
                    ...
                    <select name="violation_type" required class="w-full cursor-pointer rounded-lg border border-gray-300 px-3 py-2">
                ...
                <div class="flex gap-3">
                    <button type="button" onclick="document.getElementById('violationModal').classList.add('hidden'); document.getElementById('violationModal').classList.remove('flex')" class="flex-1 cursor-pointer rounded-lg border border-gray-300 py-2 text-sm font-medium">Cancel</button>
                    <button type="submit" class="flex-1 cursor-pointer rounded-lg bg-blue-600 py-2 text-sm font-medium text-white hover:bg-blue-700">Submit</button>
                </div>
            </form>
        </div>
    </div>
