...
def load_cameras(base_dir: Path | None = None) -> List[CameraConfig]:
    ...
    defaults = {
        1: {
            ...
            # Main stream for YOLO + high-res live preview
            ...
            "zones": "zones.json",
            # Prefer TCP for Dahua when UDP stalls (common on congested Wi‑Fi/LAN).
            "rtsp_transport": "tcp",
            # Substream preview + capped YOLO width for smoother dual-cam realtime.
            "preview_max_width": "1280",
            "infer_max_width": "1280",
            "ai_stream_max_width": "1120",
            "stream_fps": "18",
            "jpeg_quality": "70",
            "flush_frames": "4",
            "lite_preview": "1",
        ...
        2: {
            ...
            "port": "554",
            "rtsp_path": "/stream1",
            # Substream for smooth live preview; main stream kept for YOLO.
            "preview_rtsp_path": "/stream2",
